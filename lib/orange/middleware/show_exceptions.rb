  ...
  <h3 id="env-info">Rack ENV</h3>
    ...
    <h3 id="env-info">Orange ENV</h3>
      <table class="req">
        ...
        <tbody>
            <% orange_env.sort_by { |k, v| k.to_s }.each { |key, val| %>
            <tr>
              <td><%=h key %></td>
              <td class="code"><div><%=h val %></div></td>
            </tr>
...
<div id="explanation">
  <p>
    You're seeing this error because you use <code>Orange::Middleware::ShowExceptions</code>.
  </p>
</div>
